  ...
  return (
    <>
      <div className="flex flex-bet">
        <FavoritesBtn />
        <div
          title={`Last update at ${time} for ${locWeather?.place}`}
          className={cnr("flex", "flexcenter", styles.search_time)}
        >
          <LoaderWrapper isLoading={isLoading} loaderClass="loader-sm">
            <p>{getWeatherIcon[locWeather.wmo].alt || "Clear sky"} |</p>
            <time
              className="flex flexcenter gap-0_3"
      ...
      <div
        className={cnr(
          "flex flex-bet margin-block-auto align-items-center",
          styles.flexcol,
        )}
      >
